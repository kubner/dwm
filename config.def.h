...
static const char *fonts[]          = { "monospace:medium:size=9", "SymbolsNerdFont:size=9.5", "NotoColorEmoji:size=9:antialias=true:autohint=true", "SourceHanSans:size=9" };
...
// };
#include "/home/kub/.cache/wal/colors-wal-dwm.h"
...
static const Key keys[] = {
	...
	{ MODKEY,                 			XK_n,		   spawn,		       {.v = (const char*[]){ "st", "-e", "ncmpcpp", NULL } } },
	{ MODKEY,			                  XK_Print,  spawn,		       SHCMD("maim ~/pix/screenshots/screenshot_$(date +%Y_%m_%d_%H-%M-%S).png") },
	{ MODKEY|ControlMask,			      XK_Print,  spawn,		       SHCMD("maim -s ~/pix/screenshots/screenshot_$(date +%Y_%m_%d_%H-%M-%S).png") },
